...
$canonicalUrl = 'https://rsrealstatesolutions.com/offers/roof-repair-el-paso/';
...
$ogImage = 'https://rsrealstatesolutions.com/assets/roofing-landing-hero.jpg';
    ...
    >
        ...
        <div class="container roof-lp-contact-grid">
            ...
            <div class="roof-lp-form-shell">
                ...
                <?php
                $roofFormReturnAnchor = 'roof-request';
                include __DIR__ . '/../../includes/contact-form-roofing.php';
                ?>
