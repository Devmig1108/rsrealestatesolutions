...
$canonicalUrl = 'https://rsrealstatesolutions.com/offers/hvac-repair-el-paso/request-received/';
$ogTitle = $pageTitle;
$ogDescription = $metaDescription;
$ogImage = 'https://rsrealstatesolutions.com/assets/hvac-service-el-paso.webp';
    ...
    <section>
        <div class="hvac-thanks-card">
            ...
            <div class="hvac-lp-actions">
                ...
                <a class="hvac-lp-button hvac-lp-button-secondary" href="/offers/hvac-repair-el-paso/">Return to AC repair</a>
            </div>
