...
$canonicalUrl = 'https://rsrealstatesolutions.com/offers/hvac-repair-el-paso/';
    ...
    <section class="hvac-lp-section hvac-lp-contact" id="request-service" aria-labelledby="contact-title">
        <div class="container hvac-lp-contact-grid">
            ...
            <div class="hvac-lp-form-shell">
                ...
                <?php include __DIR__ . '/../../includes/contact-form-hvac.php'; ?>
            </div>
        </div>
    </section>
...
<script type="application/ld+json">
{
    ...
    "url": "https://rsrealstatesolutions.com/offers/hvac-repair-el-paso/",
